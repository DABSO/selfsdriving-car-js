class Car{
    ...
    constructor(x, y, width, height, type){
        ...
        this.baseFriction = type == "AI" ? 0.01: Math.random() % 0.01 + 0.09;;
        this.friction = 0;
        this.angle = 0;
        this.damaged = false;
    ...
    isMovingForward(){
        return this.controls.forward == 1 || this.controls.left == 1 || this.controls.right == 1;
    }
